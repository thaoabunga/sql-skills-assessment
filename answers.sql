...
SELECT models.name, brand_name, founded FROM models LEFT JOIN brands ON(models.brand_name = brands.name) WHERE models.year = 1960;
...
FROM models AS m LEFT JOIN brands AS b ON m.brand_name = b.name WHERE b.discontinued IS NOT NULL
